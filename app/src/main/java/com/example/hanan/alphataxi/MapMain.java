...
public class MapMain extends Activity implements LocationListener, View.OnClickListener {
    ...
    private Button buttonStart, buttonPause, buttonComplete, back, logout;
    private TextView textViewMilesValue, textViewTimeValue, textViewAmount, textViewTotalFareValue;
...
int time1=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fair_map_activity);
        ...
        gratuityValues.add("Gratuity");
        for (int i = 5; i <= 20; i = i + 5) {
            gratuityValues.add("" + i);
        }
        adapter = new ArrayAdapter(this, android.R.layout.simple_spinner_dropdown_item, gratuityValues);
        /*{
        ...
        spinnerGratuityValue.setAdapter(adapter);
        ...
        buttonComplete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                Intent intent = new Intent(MapMain.this, Summary.class);
//                isFirstCall = true;
//                startActivity(intent);
                //  finish();
                Intent rec = new Intent(MapMain.this, RecyclerViewHorizontal.class);
                rec.putExtra("price", price);
                rec.putExtra("time", time1*5);
                startActivity(rec);

            }
        });
        spinnerGratuityValue.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                gratuity = spinnerGratuityValue.getSelectedItem().toString();
                if (spinnerGratuityValue.getSelectedItem().toString().equals("Gratuity")) {
                    textViewTotalFareValue.setText("" + df.format(fare));

                } else {
                    double gratuityAmount = Integer.parseInt(gratuity);
                    //fareWithGratuity = (gratuityAmount / 100) * fare;
                    fareWithGratuity = fare + fareWithGratuity;
                    textViewTotalFareValue.setText("" + df.format(fareWithGratuity));
                    price=(int)fareWithGratuity;
                }
            }
    ...
    private Location getCustomLastKnownLocation() {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != getApplication().getPackageManager().PERMISSION_GRANTED && ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != getApplication().getPackageManager().PERMISSION_GRANTED) {
            ...
            locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 5000, 0, MapMain.this);
...
//        }
                ...
                alertDialogBuilder
                        ...
                        .setNegativeButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                editor.apply();
                                startActivity(new Intent(MapMain.this, MainActivity.class));
                            }
                        })
                ;
    ...
    private class connectAsyncTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = new ProgressDialog(MapMain.this);
...
//                distance = distance(bestLocation.getLatitude(), bestLocation.getLongitude(), destLatitude, destLongitude);
                ...
                textViewAmount.setText(""+df.format(distance));
              ...
              /*  if (Integer.parseInt(gratuity) != 0){
                ...
                textViewMilesValue.setText("" + df.format(dist));
    ...
    private void registerViews() {
        ...
        textViewMilesValue = (TextView) findViewById(R.id.textViewMilesValue);
        textViewMilesValue.setTypeface(face);
        textViewTimeValue = (TextView) findViewById(R.id.textViewTimeValue);
        textViewTimeValue.setTypeface(face);
        spinnerGratuityValue = (Spinner) findViewById(R.id.spinnerGratuityValue);
//        spinnerGratuityValue.setTypeface(face);
        textViewAmount = (TextView) findViewById(R.id.textViewAmount);
        textViewAmount.setTypeface(face);
        textViewTotalFareValue = (TextView) findViewById(R.id.textViewTotalFareValue);
        textViewTotalFareValue.setTypeface(face);
    ...
    private Runnable updateTimerThread = new Runnable() {
        ...
        public void run() {
            ...
            textViewTimeValue.setText("" + String.format("%02d", hours) + ":" + "" + String.format("%02d", mins)
